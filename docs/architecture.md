...
- **Access Model**: The bucket is private by default. Direct public reading/writing is forbidden. Clients read and write objects using time-limited Signed URLs issued by the FastAPI backend after rigorous authorization validation.
