"""Comprehensive integration tests for File uploads, downloads, versioning, metadata, and management."""
...
# ============================================================================
# 1. Direct Multipart Upload Tests
# ============================================================================
...
# ============================================================================
# 4. Download and Streaming Tests
# ============================================================================
...
# ============================================================================
# 6. File Metadata Management (Rename, Move, Copy, Star)
# ============================================================================
...
def test_permanent_delete_purges_storage_and_quota(client, auth_headers, test_user, db_session):
    ...
    # Quota decremented back to 0
    db_session.refresh(test_user)
    assert test_user.storage_used_bytes == 0


# ============================================================================
# 8. Multi-Tenancy & Security Isolation
# ============================================================================
...
def test_multi_tenancy_file_isolation(client, auth_headers, other_auth_headers):
    ...
    # User B attempts to get details
